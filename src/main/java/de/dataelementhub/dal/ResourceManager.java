...
public class ResourceManager {
  ...
  /**
   * Creates a DSLContext for the previously initialized parameters. This is a Resource and has to
   * be closed after use! https://stackoverflow.com/questions/27773698/how-to-manage-dslcontext-in-jooq-close-connection
   */
  public static synchronized CloseableDSLContext getDslContext()

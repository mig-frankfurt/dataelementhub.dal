...
public class Indexes {
    ...
    public static final Index SCOPED_IDENTIFIER_VERSION_IDX = Internal.createIndex(DSL.name("scoped_identifier_version_idx"), ScopedIdentifier.SCOPED_IDENTIFIER, new OrderField[] { ScopedIdentifier.SCOPED_IDENTIFIER.REVISION }, false);

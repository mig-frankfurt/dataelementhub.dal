...
public class ScopedIdentifierRecord extends UpdatableRecordImpl<ScopedIdentifierRecord> implements Record10<Integer, ElementType, Integer, Integer, Integer, Status, Integer, Integer, UUID, Boolean> {
    ...
    @Override
    public ScopedIdentifierRecord value5(Integer value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public ScopedIdentifierRecord value6(Status value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public ScopedIdentifierRecord value9(UUID value) {
        setUuid(value);
        return this;
    }

    @Override
    public ScopedIdentifierRecord value10(Boolean value) {
        setHidden(value);
        return this;
    }

    @Override
    public ScopedIdentifierRecord values(Integer value1, ElementType value2, Integer value3, Integer value4, Integer value5, Status value6, Integer value7, Integer value8, UUID value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScopedIdentifierRecord(Integer id, ElementType elementType, Integer version, Integer identifier, Integer createdBy, Status status, Integer elementId, Integer namespaceId, UUID uuid, Boolean hidden) {
        super(ScopedIdentifier.SCOPED_IDENTIFIER);

...
public class ConceptsDao extends DAOImpl<ConceptsRecord, de.dataelementhub.dal.jooq.tables.pojos.Concepts, Integer> {

    /**
     * Create a new ConceptsDao without any configuration
     */
    public ConceptsDao() {
        super(Concepts.CONCEPTS, de.dataelementhub.dal.jooq.tables.pojos.Concepts.class);
    }
    ...
    public ConceptsDao(Configuration configuration) {
        super(Concepts.CONCEPTS, de.dataelementhub.dal.jooq.tables.pojos.Concepts.class, configuration);
    }

    @Override
    public Integer getId(de.dataelementhub.dal.jooq.tables.pojos.Concepts object) {
        return object.getId();
    }
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchById(Integer... values) {
     ...
     */
    public de.dataelementhub.dal.jooq.tables.pojos.Concepts fetchOneById(Integer value) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchBySystem(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchByVersion(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchByTerm(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchByText(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchBySourceId(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchByCreatedBy(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Concepts> fetchByCreatedAt(LocalDateTime... values) {

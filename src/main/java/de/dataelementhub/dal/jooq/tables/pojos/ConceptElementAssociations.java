...
public class ConceptElementAssociations implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final ConceptElementAssociations other = (ConceptElementAssociations) obj;
        if (this.conceptId == null) {
            if (other.conceptId != null)
                return false;
        }
        else if (!this.conceptId.equals(other.conceptId))
            return false;
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((this.conceptId == null) ? 0 : this.conceptId.hashCode());

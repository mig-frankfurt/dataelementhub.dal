...
public class ImportRecord extends UpdatableRecordImpl<ImportRecord> implements Record9<Integer, LocalDateTime, Integer, Integer, String, String, UUID, LocalDateTime, ProcessStatus> {

    private static final long serialVersionUID = -730899015;
    ...
    @Override
    public Row9<Integer, LocalDateTime, Integer, Integer, String, String, UUID, LocalDateTime, ProcessStatus> valuesRow() {
    ...
    @Override
    public ImportRecord values(Integer value1, LocalDateTime value2, Integer value3, Integer value4, String value5, String value6, UUID value7, LocalDateTime value8, ProcessStatus value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ImportRecord(Integer id, LocalDateTime createdAt, Integer createdBy, Integer namespaceId, String source, String label, UUID uuid, LocalDateTime convertedAt, ProcessStatus status) {
        super(Import.IMPORT);

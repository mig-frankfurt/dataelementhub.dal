...
public class DefinitionDao extends DAOImpl<DefinitionRecord, de.dataelementhub.dal.jooq.tables.pojos.Definition, Integer> {

    /**
     * Create a new DefinitionDao without any configuration
     */
    public DefinitionDao() {
        super(Definition.DEFINITION, de.dataelementhub.dal.jooq.tables.pojos.Definition.class);
    }
    ...
    public DefinitionDao(Configuration configuration) {
        super(Definition.DEFINITION, de.dataelementhub.dal.jooq.tables.pojos.Definition.class, configuration);
    }

    @Override
    public Integer getId(de.dataelementhub.dal.jooq.tables.pojos.Definition object) {
        return object.getId();
    }
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Definition> fetchById(Integer... values) {
     ...
     */
    public de.dataelementhub.dal.jooq.tables.pojos.Definition fetchOneById(Integer value) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Definition> fetchByScopedIdentifierId(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Definition> fetchByDesignation(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Definition> fetchByDefinition(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Definition> fetchByLanguage(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Definition> fetchByElementId(Integer... values) {

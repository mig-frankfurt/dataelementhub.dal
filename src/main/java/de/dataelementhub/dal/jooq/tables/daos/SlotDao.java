...
public class SlotDao extends DAOImpl<SlotRecord, de.dataelementhub.dal.jooq.tables.pojos.Slot, Integer> {

    /**
     * Create a new SlotDao without any configuration
     */
    public SlotDao() {
        super(Slot.SLOT, de.dataelementhub.dal.jooq.tables.pojos.Slot.class);
    }
    ...
    public SlotDao(Configuration configuration) {
        super(Slot.SLOT, de.dataelementhub.dal.jooq.tables.pojos.Slot.class, configuration);
    }

    @Override
    public Integer getId(de.dataelementhub.dal.jooq.tables.pojos.Slot object) {
        return object.getId();
    }
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Slot> fetchById(Integer... values) {
     ...
     */
    public de.dataelementhub.dal.jooq.tables.pojos.Slot fetchOneById(Integer value) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Slot> fetchByScopedIdentifierId(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Slot> fetchByKey(String... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.Slot> fetchByValue(String... values) {

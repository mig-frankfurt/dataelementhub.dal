...
public class UserNamespaceGrants extends TableImpl<UserNamespaceGrantsRecord> {
    ...
    private static final long serialVersionUID = -363176532;
     ...
     */
    public final TableField<UserNamespaceGrantsRecord, GrantType> GRANT_TYPE = createField(DSL.name("grant_type"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(de.dataelementhub.dal.jooq.enums.GrantType.class), this, "");
    ...
    public DehubUser dehubUser() {
        return new DehubUser(this, Keys.USER_NAMESPACE_GRANTS__USER_NAMESPACE_GRANTS_USER_FKEY);
    }

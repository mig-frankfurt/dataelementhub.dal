...
public class ConceptElementAssociationsDao extends DAOImpl<ConceptElementAssociationsRecord, de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations, Record2<Integer, Integer>> {

    /**
     * Create a new ConceptElementAssociationsDao without any configuration
     */
    public ConceptElementAssociationsDao() {
        super(ConceptElementAssociations.CONCEPT_ELEMENT_ASSOCIATIONS, de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations.class);
    }
    ...
    public ConceptElementAssociationsDao(Configuration configuration) {
        super(ConceptElementAssociations.CONCEPT_ELEMENT_ASSOCIATIONS, de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations.class, configuration);
    }

    @Override
    public Record2<Integer, Integer> getId(de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations object) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations> fetchByConceptId(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations> fetchByScopedidentifierId(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations> fetchByLinktype(RelationType... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations> fetchByCreatedBy(Integer... values) {
     ...
     */
    public List<de.dataelementhub.dal.jooq.tables.pojos.ConceptElementAssociations> fetchByCreatedAt(LocalDateTime... values) {
